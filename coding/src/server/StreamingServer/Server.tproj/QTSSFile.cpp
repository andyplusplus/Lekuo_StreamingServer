...
//函数以 QTSS_OpenFilePreProcess_Role 调用所有注册Open File Preprocess的模块.
//如果返回失败, 则以 QTSS_OpenFile_Role 角色调用注册模块
...
//以QTSS_ReadFile_Role角色调用注册该角色的模块
