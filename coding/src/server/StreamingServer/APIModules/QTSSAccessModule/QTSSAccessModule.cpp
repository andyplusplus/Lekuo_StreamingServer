...
//static char* sGroupsFilePath = NULL;
	...
	//The value of sDefaultUsersFilePath Should be reset
	StrPtrLenDel sDefaultUsersFilePath_Del;	//New
	char* sDefaultUsersFilePath = NULL;		// = DEFAULTPATHS_ETC_DIR "qtusers";
	static char* sUsersFilePath = NULL;

	//The value of sDefaultGroupsFilePath Should be reset
	StrPtrLenDel sDefaultGroupsFilePath_Del;	//New
	char* sDefaultGroupsFilePath = NULL;		// = DEFAULTPATHS_ETC_DIR "qtgroups";
	static char* sGroupsFilePath = NULL;
//_WZD_PATH_ End
