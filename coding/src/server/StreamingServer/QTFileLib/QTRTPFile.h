...
public:
    ...
    //
    // Class typedefs. 该结构是一个简单的数据结构, 主要封装了文件Cache表项
...
public:
    ...
    // Accessors
            ...
            char *      GetSDPFile(int * SDPFileLength);	//由mov文件构造SDP文件的媒体相关部分
...
protected:
    ...
    RTPTrackListEntry   *fFirstTrack, *fLastTrack, *fCurSeekTrack;	//维护HintTrack列表的数据结构
