...
class PLBroadcastDef {
    ...
    public:
        ...
        char*   mDestAddress;           // 159.99.242.44  set by PLB to be resolved address
        ...
        char*   mPlayListFile;          // [os file path] *<PLBroadcastDef-name>.ply, 比如untitled.ply
    ...
    protected:
        ...
        Bool16  SetValue( char** dest, const char* value);		//为*dest申请内存, 并把*value 拷贝到该内存
        Bool16  SetDefaults( const char* setupFileName );		//设置相关属性的默认值
        Bool16  fDebug;
};
