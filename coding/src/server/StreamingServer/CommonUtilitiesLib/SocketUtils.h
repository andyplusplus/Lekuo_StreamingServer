...
class SocketUtils
{
    public:
        ...
        static Bool16   IsMulticastIPAddr(UInt32 inAddress);		//是否是组播地址
        static Bool16   IsLocalIPAddr(UInt32 inAddress);			//是否是本地地址
    ...
    private:
        ...
        static IPAddrInfo*              sIPAddrInfoArray;	//本机的IP地址数组
        static UInt32                   sNumIPAddrs;		//该机器所具有的IP地址数目
