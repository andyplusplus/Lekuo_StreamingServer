...
/* Platform-specific components */
    ...
    // POSIX errorcodes
#ifndef ENOTCONN  //Added by WZD for visual studio 2010
	#define ENOTCONN 1002		//没有连接??
    #define EADDRINUSE 1004		//地址正在使用 
    #define EINPROGRESS 1007	//
    #define ENOBUFS 1008		//没有缓存
    #define EADDRNOTAVAIL 1009	//地址不可用
#endif
    ...
    struct iovec {		//iovec往往是一个数组，在发送数据时，把数组成员的各iov_base拷贝进SendBuffer，然后再调用发送函数
...
typedef SInt32 OS_Error;		//TBD, tempmarked by wuzengde, 2007.10.03, for pass the compilation of RTSPClientLib project
