...
class OSMemory
{
    public:
		...
		//_WZD_Comment_Off_Start  2008.06.15
...
#ifndef __PLACEMENT_NEW_INLINE	//by wuzengde, 2008.05.30, to avoid the error  ------  error C2084: function 'void *operator new(size_t,void *) throw()' already has a body
// 
// PLACEMENT NEW OPERATOR
//_WZD_Comment_Off_Start
