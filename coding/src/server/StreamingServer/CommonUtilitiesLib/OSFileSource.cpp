...
/*
    File:       osfile.cpp  OSFileSource.cpp
...
//该函数主要用于分配缓存，其输入参数有
//	UInt32 inUnitSizeInK,				.对应于FileBlockPool的fBufferUnitSizeBytes
//	UInt32 inNumBuffSizeUnits,			.对应于fNumBuffSizeUnits??
//	UInt32 inBufferIncCount,			.FileBlockPool的最大Buffer数
