...
int select_waitevent(struct eventreq *req, void* /*onlyForMacOSX*/)
{
    ...
    if (theFDsProcessed < sNumFDsBackFromSelect)
    {
        ...
        if (!sInReadSet)
        {
            ...
            {
                // This can happen if another thread calls select__removeevent at just the right
                ...
                // by select__removeevent anyway. We need to make sure to finish iterating over
