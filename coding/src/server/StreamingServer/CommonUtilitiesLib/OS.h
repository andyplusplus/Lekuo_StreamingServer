...
class OS
{
    public:
        ...
        static SInt64   Milliseconds();		//毫秒

        static SInt64   Microseconds();		//微秒
   ...
   private:
        ...
        static SInt64 sMsecSince1900;	//从1900~1970的毫秒数
        static SInt64 sMsecSince1970;	//1970~现在的毫秒数
        static SInt64 sInitialMsec;		//服务器启动时间, OS::Milliseconds()
        static SInt32 sMemoryErr;
        static void SetDivisor();
        static SInt64 sWrapTime;		//(SInt64) 0x00000001 << 32;
        static SInt64 sCompareWrap;		//(SInt64) 0xffffffff << 32;
